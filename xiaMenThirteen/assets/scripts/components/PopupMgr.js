cc.Class({
    ...
    onLoad: function () {
        ...
        this._btnAgree = this._dissolveNotice.getChildByName("btn_agree").getComponent(cc.Button);
    ...
    showDissolveNotice:function(data)
    {
        ...
        var selfChoosed = data.states[cc.vv.gameNetMgr.seatIndex];
        this._btnAgree.interactable = !selfChoosed;
